...
DJOSER = {
    ...
    "SERIALIZERS": {
        ...
        "password_reset_confirm": "apps.user.serializers.PWSerializer",
    },
    "TEMPLATES": {
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 352428800
FILE_UPLOAD_MAX_MEMORY_SIZE = 352428800
...
if not DEBUG:
    ...
    DEFAULT_FROM_EMAIL = 'noreply@asesoriasafir.com'
    SERVER_EMAIL = 'noreply@asesoriasafir.com'
